...
procedure MixedScheduling is
    ...
    begin
        ...
        loop
            ...
            if Relative_Deadline > 0 and Completed > Absolute_Deadline then 
                Put(" ==> Task ");
                Int_IO.Put(Id, 1);
    ...
    Task_4 : T(4, 1, Warm_Up_Time, 0, 100, 0, 35); -- ID: 4
    Task_5 : T(5, 1, Warm_Up_Time, 0, 100, 0, 35); -- ID: 5
    Task_6 : T(6, 1, Warm_Up_Time, 0, 100, 0, 35); -- ID: 6
